...
#define TEGRA_WAKE_GPIO_PO7	33
#define TEGRA_WAKE_GPIO_PJ0	34
#define TEGRA_WAKE_GPIO_PK2	35
#define TEGRA_WAKE_GPIO_PI6	36
#define TEGRA_WAKE_GPIO_PBB1	37
#define TEGRA_WAKE_USB3_ID	38
#define TEGRA_WAKE_USB3_VBUS	39
