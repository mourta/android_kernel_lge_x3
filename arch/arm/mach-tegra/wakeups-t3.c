...
static struct tegra_wake_info tegra_wake_event_data_t3[] = {
	...
	{TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PO7), POLARITY_NONE},	/* wake33 */
	{TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PJ0), POLARITY_NONE},	/* wake34 */
	{TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PK2), POLARITY_NONE},	/* wake35 */
	{TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PI6), POLARITY_NONE},	/* wake36 */
	{TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_PBB1), POLARITY_NONE},	/* wake37 */
	{-EINVAL, POLARITY_NONE}, /* TEGRA_USB3_VBUS, */		/* wake38 */
	{-EINVAL, POLARITY_NONE}, /* TEGRA_USB3_ID, */		/* wake39 */
#ifdef CONFIG_MACH_X3 //                                
	{INT_USB, POLARITY_LEVEL_LO}, /* TEGRA_USB1_UTMIP, */		/* wake40 */
	{INT_USB2, POLARITY_LEVEL_LO}, /* TEGRA_USB2_UTMIP, */	/* wake41 */
#else
	{INT_USB, POLARITY_LEVEL_HI}, /* TEGRA_USB1_UTMIP, */		/* wake40 */
	{INT_USB2, POLARITY_LEVEL_HI}, /* TEGRA_USB2_UTMIP, */	/* wake41 */
#endif
	{INT_USB3, POLARITY_LEVEL_HI}, /* TEGRA_USB3_UTMIP, */	/* wake42 */
#if 0 /*                                      */
	{INT_USB2, POLARITY_LEVEL_HI}, /* TEGRA_USB2_UHSIC, */	/* wake43 */
#endif	
};
